              ...
              <q-parallax :height="440" :speed="0.0" class="col col-md-5">
                <template v-slot:media>
                  <video width="720" height="440" autoplay loop muted>
                    <source
                      type="video/webm"
                      src="../statics/videos/annotate.webm"
                    />
                  </video>
                </template>
              </q-parallax>
                ...
                <q-card-section>
                  <div class="text-justify text-body1">
                    ...
                    <a href="http://grew.fr//" target="_blank">
                      <q-icon name="img:../statics/svg/grew.svg" size="md" />
                      <q-tooltip
                        content-class="bg-accent"
            ...
            <div class="q-gutter-lg q-gutter-y-lg">
              <q-card-section class="q-gutter-y-lg">
                ...
                <q-card
                  ...
                  class="clickable clickhl col-1 grid-style-transition shadow-7"
                  @click="openURL('https://arborator.elizia.net/q.cgi')"
                >
                  <q-card-section>
                ...
                <q-card
                  ...
                  class="clickable clickhl col-1 grid-style-transition shadow-7"
                  @click="openURL('https://arborator.elizia.net/')"
                >
                  <q-card-section>
